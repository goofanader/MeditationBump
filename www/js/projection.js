...
Projection.prototype.update = function() {
	...
	var positionFromCenter = position.nonImmuteSub(monk.position);
	var acceleration = positionFromCenter.scale(-SPRING_CONSTANT).nonImmuteSub(velocity.scale(DAMPING)).scale(1/mass);
	super.update();
}